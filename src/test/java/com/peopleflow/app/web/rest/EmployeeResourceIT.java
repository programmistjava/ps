...
import com.peopleflow.app.IntegrationTest;
...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "g^[K@,hYGd.\\C";
    private static final String UPDATED_EMAIL = "9@L/^+Q.C+";
    ...
    private static final State UPDATED_STATE = State.IN_CHECK;
