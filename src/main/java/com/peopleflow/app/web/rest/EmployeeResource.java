...
/**
 * REST controller for managing {@link com.peopleflow.app.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "peopleFlowEmployee";
    ...
    public ResponseEntity<EmployeeDTO> createEmployee(@Valid @RequestBody EmployeeDTO employeeDTO) throws URISyntaxException {
        ...
        employeeDTO.setState(State.ADDED);
